...
All statistical tests were performed using R Statistical Software (v4.3.1, R Core Team, 2023) using the packages lme4 (Bates et al., 2015), emmeans (Lenth, 2023), and glmmTMB (Brooks et al., 2017). All model fits were assessed using the DHARMa package (Hartig, 2022). The code to reproduce all the statistical tests and figures included in this manuscript can be found in **varroa.virus.spillover.final.script.R**, which also includes the full list of packages used for data carpentry and visualization.
All packages and session info are listed below: 
library(dplyr)
library(tidyverse)
library(forcats)
library(glmmTMB)
